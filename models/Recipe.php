...
class Recipe {
    ...
    public function getFilteredRecipes($cuisine_id=null,$meal_type_id=null){
        ...
        if($cuisine_id && $meal_type_id){
            mysqli_stmt_bind_param($stmt,"ii",$cuisine_id,$meal_type_id);

        }
        elseif($cuisine_id){
           mysqli_stmt_bind_param($stmt,"i",$cuisine_id);


        }
        elseif($meal_type_id){
             mysqli_stmt_bind_param($stmt,"i",$meal_type_id);
        }
